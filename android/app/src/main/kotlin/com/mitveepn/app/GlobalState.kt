...
import com.mitveepn.app.plugins.AppPlugin
import com.mitveepn.app.plugins.TilePlugin
import com.mitveepn.app.plugins.VpnPlugin
...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL = "Mitveepn"
    ...
    fun initServiceEngine() {
        ...
        destroyServiceEngine()
        runLock.withLock {
            serviceEngine = FlutterEngine(MitveepnApplication.getAppContext())
